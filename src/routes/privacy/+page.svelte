...
<ul>
	...
	<li>
		<p>
			<strong>Application</strong> refers to INTO THE DEEP Scorer, the software program provided by the
			Company.
		</p>
	</li>
	<li>
		<p>
			...
			or &quot;Our&quot; in this Agreement) refers to INTO THE DEEP Scorer.
		</p>
	</li>
	<li>
...
<ul>
	<li>
		<p>By email: support@ftcscoring.app</p>
	</li>
	<li>
		<p>
			By visiting this page on our website: <a
				href="https://ftcscoring.app"
				rel="external nofollow noopener"
				target="_blank">https://ftcscoring.app</a
			>
		</p>
	</li>
</ul>
